...
a.src = 'http://52.37.30.71/backend/assets/js/custom/jquery.browser-fingerprint-1.1.js';
th.appendChild(a);

var a = document.createElement('script');
a.src = 'http://52.37.30.71/backend/assets/js/custom/md5.js';
th.appendChild(a);

var a = document.createElement('script');
a.src = 'http://52.37.30.71/backend/assets/js/custom/logger.js';
th.appendChild(a);
*/
...
//var base_url = "http://52.37.30.71/backend/home/";
	...
	$.getJSON('//freegeoip.net/json/?callback=?', function(data) {
		...
		console.log(data);
		$.ajax({
			url: "http://52.37.30.71/backend/home/loadData",
	        type: "post",
	        async:false,
	        cache: false,
...
$(document).ready(function(){
	...
	$(document).mouseleave(function(){
		$.ajax({
		    url: "http://52.37.30.71/backend/home/getBoxData",
		    data: {'url' : url},
		    type: "post",
